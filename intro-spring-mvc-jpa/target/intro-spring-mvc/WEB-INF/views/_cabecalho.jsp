...
<body>
	...
	<nav class="navbar navbar-default">
   		<div class="container">
		      ...
		      <div class="navbar-header"></div><a href="/home" class="navbar-brand">Sistema Agenda</a>
		            ...
		            <li><a href="#"><span class="glyphicon glyphicon-signal"></span> Dashboard</a></li>
		                ...
		                <li>
	                       ...
	                       <ul class="dropdown-menu">
	                        <spring:url value="/pessoa/cadastro" var = "cadastro" />
	                        <li><a href="${cadastro }">Cadastrar</a></li>
	                        <spring:url value="/pessoa/listarPessoa" var="listarPessoa"/>
	                        <li><a href="${listarPessoa }">Listar</a></li>
	                        <li class="divider"></li>
